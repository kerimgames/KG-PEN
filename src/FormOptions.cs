	...
	public partial class FormOptions : Form
	{
		...
		private void FormOptions_Load(object sender, EventArgs e)
		{
			...
			for (int p = 0; p < Root.MaxPenCount; p++)
			{
				...
				pboxPens[p].Cursor = Cursors.Hand;
				colorTip.SetToolTip(pboxPens[p], "Click to choose a custom color");
		...
		{
			this.Text = Root.Local.MenuEntryOptions + " - " + Root.AppDisplayName;
			tabPage1.Text = Root.Local.OptionsTabGeneral;
			tabPage2.Text = Root.Local.OptionsTabPens;
			tabPage3.Text = Root.Local.OptionsTabHotkeys;
			tabPage4.Text = "Sorun Bildir";
		...
		private void cbAutoText_CheckedChanged(object sender, EventArgs e)
		{
			Root.AutoTextCorrection = cbAutoText.Checked;
		}
		...
		private void btIssue_Click(object sender, EventArgs e)
		{
			try
			{
				Process.Start("https://github.com/kerimgames/KG-PEN/issues");
			}
			catch
			{
				MessageBox.Show("Bağlantı açılamadı.", "Hata", MessageBoxButtons.OK, MessageBoxIcon.Warning);
			}
		}
