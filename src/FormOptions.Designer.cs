namespace gInk
{
	partial class FormOptions
	{
		...
		private void InitializeComponent()
		{
			...
			this.cbAutoText = new System.Windows.Forms.CheckBox();
			this.btIssue = new System.Windows.Forms.Button();
			this.btIssueHotkeys = new System.Windows.Forms.Button();
			...
			this.tabPage1.Controls.Add(this.cbAutoText);
			this.tabPage1.Controls.Add(this.btIssue);
			...
			// cbAutoText
			// 
			this.cbAutoText.AutoSize = true;
			this.cbAutoText.Location = new System.Drawing.Point(16, 448);
			this.cbAutoText.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.cbAutoText.Name = "cbAutoText";
			this.cbAutoText.Size = new System.Drawing.Size(242, 24);
			this.cbAutoText.TabIndex = 10;
			this.cbAutoText.Text = "Yazı düzeltme (TR) - otomatik";
			this.cbAutoText.UseVisualStyleBackColor = true;
			this.cbAutoText.CheckedChanged += new System.EventHandler(this.cbAutoText_CheckedChanged);
			// 
			// btIssue
			// 
			this.btIssue.Location = new System.Drawing.Point(16, 488);
			this.btIssue.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.btIssue.Name = "btIssue";
			this.btIssue.Size = new System.Drawing.Size(682, 35);
			this.btIssue.TabIndex = 9;
			this.btIssue.Text = "Hata bildir (https://github.com/kerimgames/KG-PEN/issues)";
			...
			this.tabPage4.Controls.Add(this.btIssueHotkeys);
			this.tabPage4.Location = new System.Drawing.Point(4, 29);
			this.tabPage4.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.tabPage4.Name = "tabPage4";
			this.tabPage4.Size = new System.Drawing.Size(820, 672);
			this.tabPage4.TabIndex = 3;
			this.tabPage4.Text = "Sorun Bildir";
			// 
			// btIssueHotkeys
			// 
			this.btIssueHotkeys.Location = new System.Drawing.Point(16, 20);
			this.btIssueHotkeys.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.btIssueHotkeys.Name = "btIssueHotkeys";
			this.btIssueHotkeys.Size = new System.Drawing.Size(682, 35);
			this.btIssueHotkeys.TabIndex = 19;
			this.btIssueHotkeys.Text = "Hata bildir (https://github.com/kerimgames/KG-PEN/issues)";
			this.btIssueHotkeys.UseVisualStyleBackColor = true;
			this.btIssueHotkeys.Click += new System.EventHandler(this.btIssue_Click);
			// 
		...
		private System.Windows.Forms.CheckBox cbAutoText;
		...
		private System.Windows.Forms.Button btIssueHotkeys;
	}
}
